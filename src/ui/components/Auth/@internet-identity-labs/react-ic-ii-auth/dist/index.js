...
var InternetIdentityContext = React__default.createContext({
  error: null,
  authClient: null,
  identityProvider: '',
...
var useICIIAuth = function useICIIAuth(_temp) {
  ...
  var _React$useState = React__default.useState(null),
      authClient$1 = _React$useState[0],
  ...
  var createAuthClient = React__default.useCallback(function () {
    try {
      return Promise.resolve(authClient.AuthClient.create()).then(function (authClient) {
  ...
  var setAuthStatus = React__default.useCallback(function (authClient) {
    try {
  ...
  React__default.useEffect(function () {
    authClient$1 && setAuthStatus(authClient$1);
  }, [authClient$1, setAuthStatus]);
  var handleOnSuccess = React__default.useCallback(function (authClient) {
    setIsAuthenticated(true);
    onSuccess && onSuccess(authClient.getIdentity());
  }, [onSuccess]);
  var handleOnError = React__default.useCallback(function (error) {
    setError(error);
    onError && onError(error);
  }, [onError]);
  var authenticate = React__default.useCallback(function () {
    try {
      var _temp7 = function () {
        if (authClient$1) {
          return Promise.resolve(authClient$1.login(_extends({
            onSuccess: function onSuccess() {
              return handleOnSuccess(authClient$1);
            },
  ...
  }, [authClient$1, authClientOptions, handleOnError, handleOnSuccess, identityProvider]);
  var signout = React__default.useCallback(function () {
    try {
      var _temp9 = function () {
        if (authClient$1) {
          return Promise.resolve(authClient$1.logout()).then(function () {
  ...
  return {
    ...
    identity: authClient$1 ? authClient$1.getIdentity() : null,
...
var InternetIdentityProvider = function InternetIdentityProvider(_ref2) {
  ...
  return React__default.createElement(InternetIdentityContext.Provider, {
    value: authContext
  }, children);
};
var useInternetIdentity = function useInternetIdentity() {
  return React.useContext(InternetIdentityContext);
};

exports.AuthIframe = AuthIframe;
exports.InternetIdentityContext = InternetIdentityContext;
exports.InternetIdentityProvider = InternetIdentityProvider;
exports.useInternetIdentity = useInternetIdentity;
